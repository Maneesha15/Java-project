...
public class studentTable extends AbstractTableModel{
    private static final String [] COLUMN_NAMES={"Student id","First name", "Last name","Age","Email","Phone number","Gender","Admission year","Intake month","Department"};
    private static ArrayList<students> list;
    
    studentTable(ArrayList<students> stlist){
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex){
                case 0:
                    return list.get(rowIndex).getStudent_id();
                case 1:
                ...
                case 8:
                    return list.get(rowIndex).getIntake_month();
                case 9:
